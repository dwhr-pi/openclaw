...
Diese nachfolgenden Komponenten werden für Visual Studio Enterprise 2022 bei der Installtion benötigt und werden im rechten Fenster des Installers im Detailbereich vor dem Herunterladen aus-/abgewählt. Siehe [Screenshot](assets/Screenshot/_Screenshot_Microsoft_Visual_Studio_Komponenten.png). 
...
(oder kurz Windows 10 SDK – beides zusammen ist ok, weil es zwei SDKs davon gibt.)
